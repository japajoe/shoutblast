...
void TextEditor::Render(const char* aTitle, const ImVec2& aSize, bool aBorder)
{
	...
	ImGuiWindowFlags flags = ImGuiWindowFlags_HorizontalScrollbar | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoNavInputs;
	...
	if (!mIgnoreImGuiChild)
		ImGui::BeginChild(aTitle, aSize, aBorder, flags);
...
void TextEditor::SetShowHorizontalScrollbar(bool show)
{
	mShowHorizontalScrollbar = show;
}

bool TextEditor::GetShowHorizontalScrollbar() const
{
	return mShowHorizontalScrollbar;
}
